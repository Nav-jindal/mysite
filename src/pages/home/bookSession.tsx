...
const BookSession = () => {
    ...
    >
        <motion.div 
            ...
            <button type='button' className='mt-[35px] px-[18px] py-[12px] md:px-[30px] bg-[#E02720] text-[18px] sm:text-[20.25px] hover:px-[45px] transition-all duration-[200ms] ease-in-out'>Book now</button>
        </motion.div>
        <motion.div 
            initial='hidden'
            whileInView='show'
